...
/// Génère une page HTML listant les favoris — chargée sur `nyx://bookmarks`.
...
<h1 style="color:#4af2c8;font-weight:200;letter-spacing:.1em;margin-bottom:32px">
  ★ Favoris</h1>
